...
const MEALS = [
  // ─── COLAZIONE ────────────────────────────────────────────────────────────
  {
    ...
    ingredients: [
      { ingredient: 'Yogurt greco 0%',            unit: 'g',  qty_base_num: 180 },
      { ingredient: 'Frutta fresca di stagione',   unit: 'g',  qty_base_num: 100  },
      { ingredient: 'Noci',                        unit: 'g',  qty_base_num: 15},
    ],
  },
  {
    ...
    ingredients: [
      { ingredient: 'Pane integrale',  unit: 'g',  qty_base_num: 80 },
      { ingredient: 'Ricotta',         unit: 'g',  qty_base_num: 60 },
      { ingredient: 'Miele',           unit: 'g',  qty_base_num: 10  },
    ],
  },
  {
    ...
    ingredients: [
      { ingredient: 'Fiocchi d\'avena',              unit: 'g',  qty_base_num: 80},
      { ingredient: 'Latte parzialmente scremato',   unit: 'ml', qty_base_num: 200 },
      { ingredient: 'Banana',                        unit: 'pz', qty_base_num: 1},
    ],
  },
  {
    ...
    ingredients: [
      { ingredient: 'Uova',                        unit: 'pz', qty_base_num: 2},
      { ingredient: 'Pane integrale',              unit: 'g',  qty_base_num: 60 },
      { ingredient: 'Olio extravergine d\'oliva',  unit: 'ml', qty_base_num: 5},
    ],
  },
  ...
  // ─── SPUNTINO ─────────────────────────────────────────────────────────────
  {
    ...
    ingredients: [
      { ingredient: 'Gallette di riso', unit: 'pz', qty_base_num: 3},
      { ingredient: 'Hummus',           unit: 'g',  qty_base_num: 40 },
    ],
  },
  {
    ...
    ingredients: [
      { ingredient: 'Pane integrale',                    unit: 'g', qty_base_num: 40 },
      { ingredient: 'Burro di arachidi (100% arachidi)', unit: 'g', qty_base_num: 15 },
    ],
  },
  ...
  // ─── PRANZO ──────────────────────────────────────────────────────────────
  {
    ...
    ingredients: [
      { ingredient: 'Pasta integrale',              unit: 'g',  qty_base_num: 90},
      { ingredient: 'Pomodori pelati',              unit: 'g',  qty_base_num: 200 },
      { ingredient: 'Basilico fresco',              unit: 'g',  qty_base_num: 5},
      { ingredient: 'Olio extravergine d\'oliva',   unit: 'ml', qty_base_num: 10},
      { ingredient: 'Insalata mista',               unit: 'g',  qty_base_num: 100 },
    ],
  },
  {
    ...
    ingredients: [
      { ingredient: 'Petto di pollo',              unit: 'g',  qty_base_num: 180 },
      { ingredient: 'Verdure miste di stagione',   unit: 'g',  qty_base_num: 200 },
      { ingredient: 'Pane integrale',              unit: 'g',  qty_base_num: 50},
      { ingredient: 'Olio extravergine d\'oliva',  unit: 'ml', qty_base_num: 8},
    ],
  },
  {
    ...
    ingredients: [
      { ingredient: 'Legumi misti (lenticchie/fagioli/ceci)', unit: 'g',  qty_base_num: 150 },
      { ingredient: 'Brodo vegetale',                          unit: 'ml', qty_base_num: 300 },
      { ingredient: 'Carote',                                  unit: 'g',  qty_base_num: 80},
      { ingredient: 'Sedano',                                  unit: 'g',  qty_base_num: 50},
      { ingredient: 'Pane integrale',                          unit: 'g',  qty_base_num: 80},
      { ingredient: 'Olio extravergine d\'oliva',              unit: 'ml', qty_base_num: 8},
    ],
  },
  {
    ...
    ingredients: [
      { ingredient: 'Riso integrale',              unit: 'g',  qty_base_num: 90},
      { ingredient: 'Salmone fresco',              unit: 'g',  qty_base_num: 150 },
      { ingredient: 'Verdure grigliate miste',     unit: 'g',  qty_base_num: 150 },
      { ingredient: 'Olio extravergine d\'oliva',  unit: 'ml', qty_base_num: 8},
    ],
  },
  {
    ...
    ingredients: [
      { ingredient: 'Farro perlato',               unit: 'g',  qty_base_num: 80},
      { ingredient: 'Tonno al naturale',           unit: 'g',  qty_base_num: 120 },
      { ingredient: 'Pomodorini',                  unit: 'g',  qty_base_num: 150 },
      { ingredient: 'Olive (es. taggiasche)',       unit: 'pz', qty_base_num: 10},
      { ingredient: 'Olio extravergine d\'oliva',  unit: 'ml', qty_base_num: 8},
    ],
  },
  ...
  // ─── MERENDA (lui e lei) ──────────────────────────────────────────────────
  {
    ...
    ingredients: [
      { ingredient: 'Yogurt magro naturale', unit: 'g', qty_base_num: 150 },
      { ingredient: 'Miele',                unit: 'g', qty_base_num: 8},
    ],
  },
  {
    ...
    ingredients: [
      { ingredient: 'Gallette di riso',          unit: 'pz', qty_base_num: 3},
      { ingredient: 'Marmellata senza zucchero', unit: 'g',  qty_base_num: 20 },
    ],
  },
  // ─── CENA ─────────────────────────────────────────────────────────────────
  {
    ...
    ingredients: [
      { ingredient: 'Merluzzo fresco o surgelato', unit: 'g',  qty_base_num: 200 },
      { ingredient: 'Patate',                      unit: 'g',  qty_base_num: 200 },
      { ingredient: 'Insalata verde',              unit: 'g',  qty_base_num: 100 },
      { ingredient: 'Rosmarino',                   unit: 'g',  qty_base_num: 2},
      { ingredient: 'Olio extravergine d\'oliva',  unit: 'ml', qty_base_num: 8},
    ],
  },
  {
    ...
    ingredients: [
      { ingredient: 'Fagioli borlotti o cannellini', unit: 'g',  qty_base_num: 100 },
      { ingredient: 'Carote',                         unit: 'g',  qty_base_num: 80},
      { ingredient: 'Zucchine',                       unit: 'g',  qty_base_num: 80},
      { ingredient: 'Patate',                         unit: 'g',  qty_base_num: 80},
      { ingredient: 'Pomodori pelati',                unit: 'g',  qty_base_num: 100 },
      { ingredient: 'Brodo vegetale',                 unit: 'ml', qty_base_num: 400 },
      { ingredient: 'Pane integrale',                 unit: 'g',  qty_base_num: 60},
      { ingredient: 'Olio extravergine d\'oliva',     unit: 'ml', qty_base_num: 8},
    ],
  },
  {
    ...
    ingredients: [
      { ingredient: 'Petto di tacchino',           unit: 'g',  qty_base_num: 180 },
      { ingredient: 'Quinoa',                      unit: 'g',  qty_base_num: 80},
      { ingredient: 'Verdure grigliate miste',     unit: 'g',  qty_base_num: 150 },
      { ingredient: 'Olio extravergine d\'oliva',  unit: 'ml', qty_base_num: 8},
    ],
  },
  {
    ...
    ingredients: [
      { ingredient: 'Uova',                                   unit: 'pz', qty_base_num: 3},
      { ingredient: 'Verdure miste (zucchine, peperoni...)',   unit: 'g',  qty_base_num: 150 },
      { ingredient: 'Pane integrale',                         unit: 'g',  qty_base_num: 50},
      { ingredient: 'Olio extravergine d\'oliva',             unit: 'ml', qty_base_num: 8},
    ],
  },
  {
    ...
    ingredients: [
      { ingredient: 'Farro perlato',               unit: 'g',  qty_base_num: 80},
      { ingredient: 'Ceci lessi',                  unit: 'g',  qty_base_num: 200 },
      { ingredient: 'Brodo vegetale',              unit: 'ml', qty_base_num: 400 },
      { ingredient: 'Rosmarino',                   unit: 'g',  qty_base_num: 2},
      { ingredient: 'Aglio',                       unit: 'pz', qty_base_num: 1},
      { ingredient: 'Olio extravergine d\'oliva',  unit: 'ml', qty_base_num: 8},
    ],
  },
];
